...
newtype WrapLedgerConfig        i blk = WrapLedgerConfig          { unwrapLedgerConfig          :: LedgerConfig              i blk   }
newtype WrapLedgerEvent         i blk = WrapLedgerEvent           { unwrapLedgerEvent           :: AuxLedgerEvent (LedgerState i blk)  }
newtype WrapLedgerErr             i blk = WrapLedgerErr             { unwrapLedgerErr             :: LedgerError                 i blk   }
...
deriving instance Eq (LedgerError              i blk ) => Eq (WrapLedgerErr      i blk)
...
deriving instance Show (LedgerError            i blk ) => Show (WrapLedgerErr             i blk)
...
deriving instance NoThunks (LedgerError              i blk ) => NoThunks (WrapLedgerErr       i blk)
