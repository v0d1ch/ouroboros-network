...
-- there's no other event to arm. If any activity occurs again before the previous
-- one timesout, then the timeout is reset with the new event and the other one is
-- discarded.
--
